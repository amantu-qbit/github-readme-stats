...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    ...
    "statcard.private-contribs": {
      ...
      kr: "비공개 기여",
      nl: "Privébijdragen",
      "pt-br": "Contribuições Privadas",
      "pt-pt": "Contribuições Privadas",
      ru: "Приватные вклады",
      tr: "Özel Katkılar",
      uk: "Приватні внески",
      "uk-ua": "Приватні внески",
      pl: "Wkłady prywatne",
      vi: "Đóng góp riêng tư",
      ar: "المساهمات الخاصة",
      id: "Kontribusi Pribadi",
      ta: "தனிப்பட்ட பங்களிப்புகள்",
      th: "การมีส่วนร่วมส่วนตัว",
      he: "תרומות פרטיות",
    },
    "statcard.total-contribs": {
      en: "Total Contributions",
      cn: "总贡献数",
      "zh-tw": "總貢獻數",
      de: "Beiträge insgesamt",
      ...
      kr: "총 기여",
      nl: "Totale bijdragen",
      "pt-br": "Total de Contribuições",
      "pt-pt": "Total de Contribuições",
      ru: "Всего вкладов",
      tr: "Toplam Katkı",
      uk: "Всього внесків",
